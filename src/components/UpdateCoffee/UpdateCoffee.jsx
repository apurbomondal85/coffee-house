    ...
    return (
        <div>
            ...
            <div className='container py-16 bg-[#F4F3F0]'>
                <h1 className='text-center text-4xl text-[#374151] font-bold'>Update Existing Coffee Details</h1>
                ...
                <form onSubmit={handleUpdateCoffee} className='px-8 md:px-16 lg:px-24'>
                    <div className="grid md:grid-cols-2 md:gap-6">
                        <div className="relative z-0 w-full mb-6 group">
                            <input type="text" name="name" defaultValue={name} id="name" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=' ' required />
                        ...
                        <div className="relative z-0 w-full mb-6 group">
                            <input type="text" name="chef" defaultValue={chef} id="chef" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=' ' required />
                        ...
                        <div className="relative z-0 w-full mb-6 group">
                            <input type="text" name="supplier" defaultValue={supplier} id="supplier" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=' ' required />
                        ...
                        <div className="relative z-0 w-full mb-6 group">
                            <input type="text" name="taste" defaultValue={taste} id="taste" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=' ' required />
                        ...
                        <div className="relative z-0 w-full mb-6 group">
                            <input type="text" name="category" defaultValue={category} id="category" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=' ' required />
                        ...
                        <div className="relative z-0 w-full mb-6 group">
                            <input type="text" name="details" defaultValue={details} id="details" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=' ' required />
                    ...
                    <div className="relative z-0 w-full mb-6 group">
                        <input type="url" name="photo" defaultValue={photo} id="photo" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=' ' required />
                    ...
                    <Button type='submit' className='bg-[#D2B48C] hover:bg-[#e1b985] w-full mt-4'>Update Coffee</Button>
                </form>
            </div>
        </div>
    )
